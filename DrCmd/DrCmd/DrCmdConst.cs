...
namespace DrOpen.DrCommon.DrCmd
{
    ...
    public enum DrCmdOptionSettings
    {
        ...
        ValueFlags,
        /// <summary>
        /// Full name of Type for return value. List of supported types equals supported types by <see cref="DrData.DDValue"/>. For validate type call to <see cref="DrOpen.DrCommon.DrData.DDValue.ValidateType()"/>. By default type of value is <see value="String.String[]"/>
        /// </summary>
        ValueType,
        /// <summary>
        ...
        ResultValue,
        /// <summary>
        /// Returns the specified value of option as string array.
        /// Different from the <see cref="Value"/> it returns only specified value for this options.
        /// Different from the <see cref="ResultValue"/> it always returns as string array.
        /// you should be escaped double quotes (") by backslash (\) in the value like (\") in the windows command line
        /// </summary>
