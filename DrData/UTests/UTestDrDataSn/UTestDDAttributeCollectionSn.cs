...
{
    [TestClass]
    public class UTestDDAttributeCollectionSn
    {
        ...
        public void TestDDAttributesCollectionXmlDirectSerialization()
        {
            ...
            var ac = DDAttributesCollectionSne.Deserialize(sb.ToString());
        ...
        public void TestDDAttributesCollectionXmlSerializationGetSchemaNull()
        {
            ...
            Assert.IsNull(((DDAttributesCollectionSn)a).GetSchema(), "XML schema should be null.");
        }
        ...
        {
            var v = (DDAttributesCollectionSn)value;
        ...
        private DDAttributesCollectionSn XMLDeserialize(MemoryStream stream)
        {
            var serializer = new XmlSerializer(typeof(DDAttributesCollectionSn));
            return (DDAttributesCollectionSn)serializer.Deserialize(stream);
        }
