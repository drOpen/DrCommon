...
namespace DrOpen.DrCommon.DrDataSn
{
    ...
    public class DDNodeSn: IXmlSerializable
    {
        ...
        {
            DDNodeSne.XMLSerialize(this.n, writer);
        }
        ...
        {
            this.n = DDNodeSne.Deserialize(reader);
        }
        ...
        /// <returns></returns>
        public static explicit operator DDNodeSn(DDNode n)
        {
            return (n == null ? null : new DDNodeSn(n));
        }
        /// <summary>
        /// unbox DDNode
        /// </summary>
        /// <param name="n"></param>
        /// <returns></returns>
        public static implicit operator DDNode(DDNodeSn n)
        {
    ...
    public static class DDNodeSne
    {
        ...
        {
            //if (n.Name != null) writer.WriteAttributeString("n", n.Name);
            //if (String.IsNullOrEmpty(n.Type) == false) writer.WriteAttributeString("t", n.Type); // write none empty type
